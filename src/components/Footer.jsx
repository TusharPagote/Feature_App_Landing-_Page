        ...
        <div className='w-full bg-white py-24'>
            <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
                ...
                <div className='col-span-2'>
                    ...
                    <h3 className='py-2 text-[#6D737A]'>Call : +91 90674 40971</h3>
                    <h3 className='py-2 text-[#6D737A]'>Jamdarwadi Nagpur <br></br> Maharastra - 440017</h3>
                    <h3 className='py-2 text-[#363A3D]'>Email: ptusharp@gmail.com</h3>
                ...
                <div className='max-[780px]:col-span-2'>
                    ...
                    <h3 className='py-2 text-[#6D737A]'>
                        "How about: " <br></br> 'Unlock Limitless Learning - Subscribe Today!'</h3>
                    <form className='py-4'>
                        <input
